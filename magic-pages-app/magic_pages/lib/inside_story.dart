        ...
        children: [
              ...
              child: storyIndex == 0
                  ...
                  : GestureDetector(
                      ...
                      child: AnimatedContainer(
                        height: 50,
                        margin: isBackPressed
                            ? const EdgeInsets.fromLTRB(16, 6, 8, 0)
                            : const EdgeInsets.fromLTRB(16, 0, 8, 6),
                        decoration: BoxDecoration(
                            color: const Color(0xFFFDFDFD),
                            borderRadius: BorderRadius.circular(25),
                            border: Border.all(
          ...
          Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: const Center(
                  child: Image(
                      image: AssetImage('assets/images/nav-icons/home.webp'), width: 35),
                ),
              ),
            ),
          ),
          Expanded(
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                height: 50,
                margin: isNextPressed
                    ? const EdgeInsets.fromLTRB(8, 6, 16, 0)
                    : const EdgeInsets.fromLTRB(8, 0, 16, 6),
                decoration: BoxDecoration(
                    color: const Color(0xFFFE8D29),
                    borderRadius: BorderRadius.circular(25),
                    boxShadow: isNextPressed
                        ? null
                        : [
                            const BoxShadow(
