...
class StoryGenerationTest {
    ...
    public void extractContent() {
        ...
        //should return null
        try {
            StoryGeneration gen = new StoryGeneration(new APICalls("fullstack_fox/recources/configTest.json"));

            String content = gen.extractContent(inStoryNull);
            Assertions.assertNull(content);

            content = gen.extractContent(inStoryContent);
            Assertions.assertEquals(content, "I am content");
    ...
    void finish_reason() {
        ...
        try {
            ...
            Assertions.assertEquals(finishReason, "I am a finish reason");
    ...
    void splitParagraphs() {
        ...
        try {
            ...
            Assertions.assertEquals(paragraphs.get(0), "para1");
            Assertions.assertEquals(paragraphs.get(1), "para2");
            Assertions.assertEquals(paragraphs.get(2), "para3");
    ...
    void splitNumberedList() {
        ...
        try {
            ...
            Assertions.assertEquals("Hello there", paragraphs.get(0));
            Assertions.assertEquals("My Child", paragraphs.get(1));
            Assertions.assertEquals("Good to see you", paragraphs.get(2));
